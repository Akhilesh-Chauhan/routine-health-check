...
Cron usage:
    */15 * * * * /usr/bin/env hc monitor liveness >> /path/to/liveness_monitor.log 2>&1
"""
import json
import os
...
from health_check.orchestration import master as m   # reuse liveness_sweep()
from health_check.orchestration.alerts import send_email

STATE = str(paths.LIVENESS_STATE)
LATEST = str(paths.ARTIFACTS_DIR / "liveness_latest.json")
