...
Reads:  artifacts/master_report.json
...
def main(argv=None):
    ...
    ap.add_argument("--report", default=REPORT,
                    help="path to master_report.json (default: artifacts/master_report.json)")
    ap.add_argument("--out", default=OUT,
                    help="path to write dashboard.html (default: dashboard.html)")
    ...
    if not os.path.exists(report_path):
        data = {}
        print(f"[warn] No master_report.json at {report_path}; emitting empty dashboard.", flush=True)
    else:
    ...
    print(f"[ok] Open in browser:  file://{out_path}")
